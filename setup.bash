...
cd ..
./gradlew distDocker -PdockerImagePrefix=openwhisk -PdockerImageTag=nightly
cd ansible
...
ansible-playbook openwhisk.yml -e docker_image_prefix=openwhisk -e docker_image_tag=nightly -e pid_mode=host -e invoker_use_runc=false
# -e whisk_loglevel=DEBUG
