...
import org.apache.openwhisk.core.entity.{ActivationId, BasicAuthenticationAuthKey, ByteSize, ControllerInstanceId, EntityName, EntityPath, ExecManifest, ExecutableWhiskActionMetaData, FullyQualifiedEntityName, Identity, InvokerInstanceId, MemoryLimit, Namespace, Secret, Subject, UUID, WhiskActionMetaData, WhiskActivation}
